...
const Footer = () => {
  return (
    <>
      <footer className="max-w-screen-xl w-full text-slate-500">
        <div className="border-t border-slate-200 bg-gray-200 pt-16 pb-12 text-sm">
          <div className="m-4">
              ...
              >
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <Link className="transition-colors duration-300 hover:text-emerald-500 focus:text-emerald-600">
                      Nepal Trekking
                    </Link>
                  </li>
                  <li className="mb-2 leading-6">
