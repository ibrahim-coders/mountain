  ...
  return (
    <Link to="/ourteem">
      <div className="text-center py-10">
        ...
        <div className="w-11/12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-8 mx-auto text-center justify-center items-center ">
          <div
            className="card card-compact bg-base-100 w-full shadow-xl relative group"
            data-aos="fade-up"
          >
            <figure>
              <img
          ...
          <div
            className="card card-compact bg-base-100 w-ful shadow-xl group"
